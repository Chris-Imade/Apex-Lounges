        ...
        <div style={{ position: "relative" }} className={[styles.form__container]}>
            <div className="form__header">
                <div className={styles.login}>
                    <img width={119} height={57} src={images.Register} alt="logo" />
                </div>
                <p className={styles.copyright}>No more unexpected outcomes, make reservations with any hotel in real-time</p>
            </div>
